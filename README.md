...
`Map` 탭은 Kakao Maps JavaScript SDK를 불러올 수 있도록 준비되어 있습니다. 실제 카카오 지도가 보이려면 Kakao Developers의 Web 플랫폼 도메인에 아래 주소를 등록해야 합니다.
...
JavaScript 키는 저장소에 커밋하지 않고, GitHub Pages 주소 뒤에 다음처럼 붙여 접속합니다.
